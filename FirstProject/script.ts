...
let mineSecretNumber:number|null;
mineSecretNumber =12;
...
//Exercise
// Before adding types how the code looks
...
//After adding types how the code looks
...
let yeahObject = {
    ...
    name: "nikhil",
    lastName: "Karanjkar",
    WholeName() { ////you can also define function statements inside the object  but you have to
...
function MyTestFunction(numbera:number,successful:boolean) {
...
// Exercise 2 - If only we could provide some default values...
var greet = (name:string="Nikhil"):void=> {
    console.log("Hello, " + name);
};
greet();
greet("Anna");
